...
class gru_module_4(nn.Module):
    ...
    X_m2 : torch tensor of shape (24, 3)
        a^t : One hot vectors representing the cheapest source [d, p, g]
...
class neuralGrU(nn.Module):
    ...
    def __init__(self, B, device=None, eta_c=1, eta_d=1):
        super().__init__()
        ...
        self.m2 = gru_module_2(eta_d=eta_d)
        self.m3 = gru_module_3()
        self.m4 = gru_module_4(eta_c=eta_c, eta_d=eta_d)

    def forward(self, pi_g, pi_p, pi_s, pi_c, pi_d, d_t):
        ...
        d_star = self.m4(d_t, i_t, a_t, i_tilda_t)
